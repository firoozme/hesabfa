...
class Login extends SimplePage
{
    ...
    protected function getForms(): array
    {
        return [
            'form' => $this->form(
                $this->makeForm()
                    ->schema([
                        $this->getFiscalYearFormComponent(),
    ...
    protected function getFiscalYearFormComponent(): Component
    {
        return Select::make('fiscal_year')
            ->label(__('filament-panels::pages/auth/login.form.fiscalyear.label'))
            ->options(FiscalYear::all()->pluck('name', 'id'))
            ->autofocus()
            ->required()
            ->selectablePlaceholder(false)
            ->default(FiscalYear::latest()->first()->id)
