    ...
    <div class="cards">
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td><a  target="_blank" href="{{ route('price.list',['record'=>$list['id']]) }}">{{ $list['name'] }}</a></td>
                    <td>{{ verta($list['start_date']) }}</td>
                    <td>{{ verta($list['end_date']) }}</td>
                    <td>{{ route('price.list',['record'=>$list['id']]) }}</td>
